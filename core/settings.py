...
DEFAULT_FROM_EMAIL = f"Gumisofts <{EMAIL_HOST_USER}>"
SERVER_EMAIL = "noreply@gumisofts.com"
EMAIL_HOST_NAME = "mail.gumisofts.com"  # This is the domain name from your error
